...
SUPPORT_NICK = "@твой_ник_поддержки"   # ← Юзернейм тех поддержки
AUTHOR_NICK = "@твой_ник"              # ← Твой личный юзернейм
DONATE_SBP = "+7 XXX XXX-XX-XX"        # ← Номер для СБП
DONATE_CARD = "XXXX XXXX XXXX XXXX"    # ← Номер карты
# ======================================
